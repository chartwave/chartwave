...
func (l *Settings) Flags() []cli.Flag {
	return []cli.Flag{
		&cli.StringFlag{
			...
			Value:       "emoji",
			EnvVars:     []string{"CHARTWAVE_LOG_FORMAT"},
		...
		&cli.StringFlag{
			...
			Value:       "info",
			EnvVars:     []string{"CHARTWAVE_LOG_LEVEL", "CHARTWAVE_LOG_LVL"},
			Destination: &l.level,
		},
		&cli.BoolFlag{
			Name:        "log-color",
			Usage:       "Force color",
			Value:       true,
			EnvVars:     []string{"CHARTWAVE_LOG_COLOR"},
			Destination: &l.color,
		},
		&cli.BoolFlag{
			Name:        "log-timestamps",
			...
			Value:       false,
			EnvVars:     []string{"CHARTWAVE_LOG_TIMESTAMPS"},
